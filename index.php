...
<?php include_once("marquee.php"); ?>
                	...
                	<div style="width:100%; padding:2px; height:290px;">
                    	<div id="mwww" loop="true" style="width:100%; height:100%;">
                        	                                <div style="width:99%; height:100%; position:relative;" class="cent">資料讀取中...</div>
                                                        </div>
                    </div>
                	<div style="width:95%; padding:2px; height:190px; margin-top:10px; padding:5px 10px 5px 10px; border:#0C3 dashed 3px; position:relative;">
							...
							<tr>
							<td width="100%" align="center">最新消息區</td>
							<?php
							...
							if($row > 5){
							?>
							<td align="right"><a href="news_list.php">More...</a></td>
							<?php } ?>
							</tr>
							</table>
                            								</span>
                            <ul class="ssaa" style="list-style-type:decimal;">
                            	                            <?php include_once("index_1_9.php"); ?></ul>
